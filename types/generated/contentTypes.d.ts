...
export interface ApiCorporateLogoCorporateLogo
  ...
  info: {
    displayName: 'corporate-logo';
    pluralName: 'corporate-logos';
    singularName: 'corporate-logo';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::corporate-logo.corporate-logo'
    > &
      Schema.Attribute.Private;
...
export interface ApiImpactContentImpactContent extends Struct.SingleTypeSchema {
  collectionName: 'impact_contents';
  info: {
    displayName: 'Impact-content';
    pluralName: 'impact-contents';
    singularName: 'impact-content';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::impact-content.impact-content'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sectionIntro: Schema.Attribute.String;
    sectionTitle: Schema.Attribute.String;
    story1Description: Schema.Attribute.Blocks;
    story1Icon: Schema.Attribute.String;
    story1Stat: Schema.Attribute.String;
    story1Title: Schema.Attribute.String;
    story2Description: Schema.Attribute.Blocks;
    story2Icon: Schema.Attribute.String;
    story2Stat: Schema.Attribute.String;
    story2Title: Schema.Attribute.String;
    story3Description: Schema.Attribute.Blocks;
    story3Icon: Schema.Attribute.String;
    story3Stat: Schema.Attribute.String;
    story3Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMediaMedia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<['youtube', 'newspaper']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPartnerSchoolPartnerSchool
  extends Struct.CollectionTypeSchema {
  collectionName: 'partner_schools';
  info: {
    displayName: 'partner-school';
    pluralName: 'partner-schools';
    singularName: 'partner-school';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::partner-school.partner-school'
    > &
      Schema.Attribute.Private;
...
export interface ApiServicesContentServicesContent
  ...
  attributes: {
    ...
    sectionIntro: Schema.Attribute.String;
    sectionTitle: Schema.Attribute.String;
    service1Description: Schema.Attribute.Text;
    service1Icon: Schema.Attribute.String;
    service2Description: Schema.Attribute.Text;
    service2Icon: Schema.Attribute.String;
    service2Title: Schema.Attribute.String;
    service3Description: Schema.Attribute.Text;
    service3Icon: Schema.Attribute.String;
    service4Description: Schema.Attribute.Text;
    service4Icon: Schema.Attribute.String;
    service4Title: Schema.Attribute.String;
    serviceTitle: Schema.Attribute.String;
    srvice3Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    analyticsCode: Schema.Attribute.String;
    copyrightText: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    donationLink: Schema.Attribute.Text;
...
export interface ApiYoutubeLinkYoutubeLink extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::impact-content.impact-content': ApiImpactContentImpactContent;
      'api::media.media': ApiMediaMedia;
      'api::organization-info.organization-info': ApiOrganizationInfoOrganizationInfo;
      'api::partner-school.partner-school': ApiPartnerSchoolPartnerSchool;
